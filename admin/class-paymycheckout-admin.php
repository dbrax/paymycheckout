 ...
 * @subpackage paymycheckout/admin
 */
...
class paymycheckout_Admin
{
	...
	public function enqueue_styles()
	{
		...
		wp_enqueue_style($this->paymycheckout, plugin_dir_url(__FILE__) . 'css/paymycheckout-admin.css', array(), $this->version, 'all');
	}
	...
	public function enqueue_scripts()
	{
		...
		wp_enqueue_script($this->paymycheckout, plugin_dir_url(__FILE__) . 'js/paymycheckout-admin.js', array('jquery'), $this->version, false);
	}
}
