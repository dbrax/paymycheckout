...
class wopay_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $wopay       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->wopay, plugin_dir_url( __FILE__ ) . 'css/wopay-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->wopay, plugin_dir_url( __FILE__ ) . 'js/wopay-public.js', array( 'jquery' ), $this->version, false );
